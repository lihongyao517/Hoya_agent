export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i HoyaAgent.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i HoyaAgent.json",
  ...
  "dialog.server.description": "Skift hvilken HoyaAgent-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker HoyaAgent i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer HoyaAgent i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater HoyaAgent i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før HoyaAgent kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter HoyaAgent igen.",
  ...
  "toast.update.description": "En ny version af HoyaAgent ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til HoyaAgent-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (HoyaAgent.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, HoyaAgent understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør HoyaAgent-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan HoyaAgent ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om HoyaAgent følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan HoyaAgent er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når HoyaAgent starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af HoyaAgent.",
