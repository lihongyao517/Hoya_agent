...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i HoyaAgent.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i HoyaAgent.json",
  ...
  "dialog.server.description": "Bytt hvilken HoyaAgent-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av HoyaAgent ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til HoyaAgent-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (HoyaAgent.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at HoyaAgent ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør HoyaAgent-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for HoyaAgent",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan HoyaAgent ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om HoyaAgent skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan HoyaAgent er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når HoyaAgent starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av HoyaAgent.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker HoyaAgent i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer HoyaAgent i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater HoyaAgent i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer HoyaAgent i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før HoyaAgent kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter HoyaAgent på nytt.",
