...
export const dict = {
  ...
  "dialog.provider.opencode.note": "使用 HoyaAgent Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "HoyaAgent 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 HoyaAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "HoyaAgent Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 HoyaAgent 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 HoyaAgent 中使用 {{provider}} 模型。",
  ...
  "provider.custom.discover.action": "一键获取全部模型",
  "provider.custom.discover.loading": "正在获取模型...",
  "provider.custom.discover.empty": "该接口没有返回模型",
  "provider.custom.discover.success.title": "模型已获取",
  "provider.custom.discover.success.description": "共 {{count}} 个模型，可勾选后提交。",
  "provider.custom.discover.failed.title": "获取模型失败",
  "provider.custom.discover.result": "已获取 {{count}} 个模型",
  "provider.custom.discover.apply": "使用已选模型",
  "provider.custom.discover.noneSelected.title": "未选择模型",
  "provider.custom.discover.noneSelected.description": "请至少勾选一个模型。",
  ...
  "dialog.plugins.empty": "在 hoya.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 HoyaAgent 服务器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在检查 HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "正在检查 {{distro}} 中的 HoyaAgent...",
  "wsl.onboarding.updatingOpencode": "正在更新 HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "正在更新 {{distro}} 中的 HoyaAgent...",
  "wsl.onboarding.updateOpencodeIn": "更新 {{distro}} 中的 HoyaAgent。",
  "wsl.onboarding.updateOpencode": "更新 HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 HoyaAgent 已就绪。",
  "wsl.onboarding.opencodeReady": "HoyaAgent 已就绪。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安装 HoyaAgent。",
  "wsl.onboarding.installOpencode": "安装 HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 HoyaAgent",
  ...
  "wsl.onboarding.wslNotInstalled.description": "HoyaAgent 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 HoyaAgent。",
  ...
  "toast.update.description": "HoyaAgent 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 HoyaAgent 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (hoya.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: HoyaAgent 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 HoyaAgent 服务器。",
  ...
  "settings.general.row.language.description": "更改 HoyaAgent 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 HoyaAgent 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 HoyaAgent 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 HoyaAgent 的主题。",
  ...
  "settings.updates.row.startup.description": "在 HoyaAgent 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 HoyaAgent。",
