export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en HoyaAgent.",
  ...
  "dialog.plugins.empty": "Plugins configurados en HoyaAgent.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de HoyaAgent se conecta esta app.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando HoyaAgent en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando HoyaAgent en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza HoyaAgent en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala HoyaAgent en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que HoyaAgent pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir HoyaAgent.",
  ...
  "toast.update.description": "Una nueva versión de HoyaAgent ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de HoyaAgent",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (HoyaAgent.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, HoyaAgent no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor HoyaAgent dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve HoyaAgent en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si HoyaAgent sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de HoyaAgent.",
