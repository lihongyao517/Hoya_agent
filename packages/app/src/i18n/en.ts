export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in HoyaAgent.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "hoyaagent.local/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in HoyaAgent.",
  ...
  "provider.custom.discover.action": "Fetch all models",
  "provider.custom.discover.loading": "Fetching models...",
  "provider.custom.discover.empty": "No models returned by this endpoint",
  "provider.custom.discover.success.title": "Models loaded",
  "provider.custom.discover.success.description": "Found {{count}} models. Adjust selection then submit.",
  "provider.custom.discover.failed.title": "Failed to fetch models",
  "provider.custom.discover.result": "{{count}} models found",
  "provider.custom.discover.apply": "Use selected",
  "provider.custom.discover.noneSelected.title": "No models selected",
  "provider.custom.discover.noneSelected.description": "Select at least one model first.",
  ...
  "dialog.plugins.empty": "Plugins configured in hoya.json",
  ...
  "dialog.server.description": "Switch which HoyaAgent server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "HoyaAgent",
  ...
  "wsl.onboarding.checkingOpencode": "Checking HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Checking HoyaAgent in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Updating HoyaAgent in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update HoyaAgent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent is ready.",
  "wsl.onboarding.installOpencodeIn": "Install HoyaAgent in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before HoyaAgent can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen HoyaAgent.",
  ...
  "toast.update.description": "A new version of HoyaAgent ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the HoyaAgent team",
  ...
  "error.chain.checkConfig": "Check your config (hoya.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, HoyaAgent does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent includes free models so you can start immediately.",
  ...
  "app.name.desktop": "HoyaAgent Desktop",
  ...
  "settings.desktop.wsl.description": "Run the HoyaAgent server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for HoyaAgent",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how HoyaAgent looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether HoyaAgent follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how HoyaAgent is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when HoyaAgent launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of HoyaAgent.",
