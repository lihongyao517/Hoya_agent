...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HoyaAgent zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "HoyaAgent.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in HoyaAgent zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in HoyaAgent zu nutzen.",
  ...
  "dialog.plugins.empty": "In HoyaAgent.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den HoyaAgent-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.checkingOpencode": "HoyaAgent wird geprüft...",
  "wsl.onboarding.checkingOpencodeIn": "HoyaAgent in {{distro}} wird geprüft...",
  "wsl.onboarding.updatingOpencode": "HoyaAgent wird aktualisiert...",
  "wsl.onboarding.updatingOpencodeIn": "HoyaAgent in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie HoyaAgent in {{distro}}.",
  "wsl.onboarding.updateOpencode": "HoyaAgent aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "HoyaAgent ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie HoyaAgent in {{distro}}.",
  "wsl.onboarding.installOpencode": "HoyaAgent installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor HoyaAgent einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann HoyaAgent erneut.",
  ...
  "toast.update.description": "Eine neue Version von HoyaAgent ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem HoyaAgent-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (HoyaAgent.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: HoyaAgent unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "HoyaAgent-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für HoyaAgent ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie HoyaAgent auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob HoyaAgent dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von HoyaAgent anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von HoyaAgent automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von HoyaAgent.",
