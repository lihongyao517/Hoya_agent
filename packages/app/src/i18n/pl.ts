export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w HoyaAgent.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w HoyaAgent.json",
  ...
  "dialog.server.description": "Przełącz serwer HoyaAgent, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie HoyaAgent w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie HoyaAgent w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj HoyaAgent w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj HoyaAgent w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim HoyaAgent będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz HoyaAgent.",
  ...
  "toast.update.description": "Nowa wersja HoyaAgent ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu HoyaAgent",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (HoyaAgent.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: HoyaAgent nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer HoyaAgent wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd HoyaAgent na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy HoyaAgent ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji HoyaAgent.",
