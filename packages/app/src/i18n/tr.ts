...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "HoyaAgent tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve HoyaAgent'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak HoyaAgent'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak HoyaAgent'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler HoyaAgent.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi HoyaAgent sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "HoyaAgent kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde HoyaAgent kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "HoyaAgent güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde HoyaAgent güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki HoyaAgent'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "HoyaAgent'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde HoyaAgent hazır.",
  "wsl.onboarding.opencodeReady": "HoyaAgent hazır.",
  "wsl.onboarding.installOpencodeIn": "HoyaAgent'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "HoyaAgent'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HoyaAgent'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından HoyaAgent'u tekrar açın.",
  ...
  "toast.update.description": "HoyaAgent'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı HoyaAgent ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (HoyaAgent.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: HoyaAgent henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "HoyaAgent Masaüstü",
  ...
  "settings.desktop.wsl.description": "HoyaAgent sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "HoyaAgent'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "HoyaAgent'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "HoyaAgent'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "HoyaAgent'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "HoyaAgent başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "HoyaAgent'un en son sürümünü kullanıyorsunuz.",
