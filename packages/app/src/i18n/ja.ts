export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "HoyaAgentが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、HoyaAgentで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してHoyaAgentで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、HoyaAgentで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "HoyaAgent.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するHoyaAgentサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "HoyaAgentを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のHoyaAgentを確認中...",
  "wsl.onboarding.updatingOpencode": "HoyaAgentを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のHoyaAgentを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のHoyaAgentを更新してください。",
  "wsl.onboarding.updateOpencode": "HoyaAgentを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のHoyaAgentの準備ができました。",
  "wsl.onboarding.opencodeReady": "HoyaAgentの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にHoyaAgentをインストールしてください。",
  "wsl.onboarding.installOpencode": "HoyaAgentをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgentがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "HoyaAgentでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、HoyaAgentをもう一度開いてください。",
  ...
  "toast.update.description": "HoyaAgentの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをHoyaAgentチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (HoyaAgent.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: HoyaAgentはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgentには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でHoyaAgentサーバーを実行します。",
  ...
  "settings.general.row.language.description": "HoyaAgentの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのHoyaAgentの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "HoyaAgentがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "HoyaAgentのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "HoyaAgent の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "HoyaAgent は最新バージョンです。",
