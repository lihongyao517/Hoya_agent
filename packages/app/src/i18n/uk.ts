export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у HoyaAgent.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в HoyaAgent.json",
  ...
  "dialog.server.description": "Перемкніть сервер HoyaAgent, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка HoyaAgent у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення HoyaAgent у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть HoyaAgent у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть HoyaAgent у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в HoyaAgent потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте HoyaAgent.",
  ...
  "toast.update.description": "Нова версія HoyaAgent ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді HoyaAgent",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (HoyaAgent.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, HoyaAgent ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер HoyaAgent всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд HoyaAgent на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи HoyaAgent використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію HoyaAgent.",
