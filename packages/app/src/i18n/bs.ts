export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u HoyaAgent-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u HoyaAgent-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u HoyaAgent-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u HoyaAgent.json",
  ...
  "dialog.server.description": "Promijeni na koji se HoyaAgent server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera HoyaAgent u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje HoyaAgent u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj HoyaAgent u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj HoyaAgent u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi HoyaAgent mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori HoyaAgent.",
  ...
  "toast.update.description": "Nova verzija HoyaAgent-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku HoyaAgent timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (HoyaAgent.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: HoyaAgent još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni HoyaAgent server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u HoyaAgent-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako HoyaAgent izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li HoyaAgent prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu HoyaAgent-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se HoyaAgent pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju HoyaAgent-a.",
