export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك HoyaAgent Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في HoyaAgent.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في HoyaAgent.json",
  ...
  "dialog.server.description": "تبديل خادم HoyaAgent الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من HoyaAgent في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث HoyaAgent في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث HoyaAgent في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت HoyaAgent في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن HoyaAgent من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على HoyaAgent التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح HoyaAgent.",
  ...
  "toast.update.description": "نسخة جديدة من HoyaAgent ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق HoyaAgent",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (HoyaAgent.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن HoyaAgent لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن HoyaAgent نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم HoyaAgent داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ HoyaAgent",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور HoyaAgent على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان HoyaAgent يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من HoyaAgent.",
