export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Бесплатные модели от HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Введите ваш API ключ {{provider}} для подключения аккаунта и использования моделей {{provider}} в HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen даёт вам доступ к отобранным надёжным оптимизированным моделям для агентов программирования.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " чтобы получить код авторизации для подключения аккаунта и использования моделей {{provider}} в HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " и введите код ниже для подключения аккаунта и использования моделей {{provider}} в HoyaAgent.",
  ...
  "dialog.plugins.empty": "Плагины настроены в HoyaAgent.json",
  ...
  "dialog.server.description": "Переключите сервер HoyaAgent к которому подключается приложение.",
  ...
  "wsl.onboarding.checkingOpencode": "Проверка HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Проверка HoyaAgent в {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Обновление HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Обновление HoyaAgent в {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Обновите HoyaAgent в {{distro}}.",
  "wsl.onboarding.updateOpencode": "Обновить HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent в {{distro}} готов к работе.",
  "wsl.onboarding.opencodeReady": "HoyaAgent готов к работе.",
  "wsl.onboarding.installOpencodeIn": "Установите HoyaAgent в {{distro}}.",
  "wsl.onboarding.installOpencode": "Установить HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent не установлен",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для добавления сервера WSL в HoyaAgent требуется WSL (Windows Subsystem for Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent не смог проверить WSL на этом компьютере.",
  "wsl.onboarding.installWsl": "Установить WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустите Windows, чтобы завершить установку WSL, затем снова откройте HoyaAgent.",
  ...
  "toast.update.description": "Новая версия HoyaAgent ({{version}}) доступна для установки.",
  ...
  "error.page.report.prefix": "Пожалуйста, сообщите об этой ошибке команде HoyaAgent",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (HoyaAgent.json)",
  "error.chain.mcpFailed":
    'MCP сервер "{{name}}" завершился с ошибкой. Обратите внимание, что HoyaAgent пока не поддерживает MCP авторизацию.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent включает бесплатные модели, чтобы вы могли начать сразу.",
  ...
  "settings.desktop.wsl.description": "Запускать сервер HoyaAgent внутри WSL на Windows.",
  ...
  "settings.general.row.language.description": "Изменить язык отображения HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Настройте как HoyaAgent выглядит на вашем устройстве",
  "settings.general.row.colorScheme.title": "Цветовая схема",
  "settings.general.row.colorScheme.description": "Выберите, следует ли HoyaAgent системной, светлой или тёмной теме",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Настройте оформление HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "Автоматически проверять обновления при запуске HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "Вы используете последнюю версию HoyaAgent.",
