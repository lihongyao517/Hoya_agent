export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans HoyaAgent.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans HoyaAgent.json",
  ...
  "dialog.server.description": "Changez le serveur HoyaAgent auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'HoyaAgent dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'HoyaAgent dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour HoyaAgent dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "HoyaAgent est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "HoyaAgent est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez HoyaAgent dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'HoyaAgent puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "HoyaAgent n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez HoyaAgent.",
  ...
  "toast.update.description":
    "Une nouvelle version d'HoyaAgent ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe HoyaAgent",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (HoyaAgent.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'HoyaAgent ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "HoyaAgent inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur HoyaAgent dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'HoyaAgent sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si HoyaAgent suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'HoyaAgent.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'HoyaAgent",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'HoyaAgent.",
