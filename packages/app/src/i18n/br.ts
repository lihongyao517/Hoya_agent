export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo HoyaAgent",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no HoyaAgent.",
  ...
  "provider.connect.opencodeZen.line1":
    "HoyaAgent Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no HoyaAgent.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no HoyaAgent.",
  ...
  "dialog.plugins.empty": "Plugins configurados em HoyaAgent.json",
  ...
  "dialog.server.description": "Trocar para qual servidor HoyaAgent este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o HoyaAgent...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o HoyaAgent em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o HoyaAgent...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o HoyaAgent em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o HoyaAgent em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o HoyaAgent",
  "wsl.onboarding.opencodeReadyIn": "O HoyaAgent está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O HoyaAgent está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o HoyaAgent em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o HoyaAgent",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "HoyaAgent não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o HoyaAgent possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O HoyaAgent não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o HoyaAgent novamente.",
  ...
  "toast.update.description": "Uma nova versão do HoyaAgent ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do HoyaAgent",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (HoyaAgent.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: HoyaAgent ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "HoyaAgent inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor HoyaAgent dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do HoyaAgent",
  ...
  "settings.general.row.appearance.description": "Personalize como o HoyaAgent aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o HoyaAgent segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o HoyaAgent é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o HoyaAgent iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do HoyaAgent.",
