...
const GLOBAL_STORAGE = "hoya.global.dat"
const WINDOW_STORAGE = "hoya.window"
const LOCAL_PREFIX = "hoya."
...
function workspaceStorage(dir: string) {
  ...
  return `hoya.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `hoya.draft.${head}.${sum}.dat`
}
