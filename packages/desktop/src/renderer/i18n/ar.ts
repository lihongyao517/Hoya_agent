export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من HoyaAgent",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من HoyaAgent، هل ترغب في تثبيته وإعادة تشغيله؟",
