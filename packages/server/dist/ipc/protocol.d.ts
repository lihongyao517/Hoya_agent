...
export type RpcServerMessage = RpcReadyResponse | RpcResponse | AgentSessionEvent | RpcExtensionUIRequest | ErrorResponse;
export type ProtocolMessage = ServerRequest | ServerResponse | RpcClientMessage | RpcServerMessage;
export type ResponseFor<T extends ServerRequest> = T extends {
    type: infer K;
} ? K extends keyof ResponseMap ? ResponseMap[K] | ErrorResponse : ErrorResponse : ErrorResponse;
export declare function encodeMessage(message: ProtocolMessage): string;
export declare function parseRequestLine(line: string): ServerRequest;
export declare function parseResponseLine(line: string): ServerResponse;
