...
function realApp(): AppBindings | undefined {
  if (typeof window !== "undefined" && window.hoya) {
    const implementedMethods: Record<string, true> = {
      ...
      SubmitToTab: true,
      SubmitDisplay: true,
      SubmitDisplayToTab: true,
      SubmitDeliveryRecoveryToTab: true,
      SubmitInvocationsToTab: true,
      SubmitEditedDisplayToTab: true,
      Capabilities: true,
      Settings: true,
      ListTabs: true,
      Tabs: true,
      ...
      Effort: true,
      EffortForTab: true,
      ReplayPendingPrompts: true,
      WorkbenchActiveTarget: true,
      Meta: true,
      MetaForTab: true,
      DesktopStartupSettings: true,
      HistoryPageForTab: true,
      HistoryCheckpointTurnsForTab: true,
      CheckpointsForTab: true,
      Models: true,
      ModelsForTab: true,
      SetModel: true,
      SetModelForTab: true,
...
export function onEvent(cb: (e: WireEvent) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on(EVENT_CHANNEL, (_e: any, payload: unknown) => cb(payload as WireEvent));
  }
...
export function onUpdaterProgress(cb: (p: UpdateProgress) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("updater:progress", (_e: any, p: unknown) => cb(p as UpdateProgress));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onRuntimeRebuilt(cb: (tabId?: string) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("runtime:rebuilt", (_e: any, tabId?: unknown) => cb(typeof tabId === "string" ? tabId : undefined));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onReady(cb: (tabId?: string) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("agent:ready", (_e: any, tabId?: unknown) => cb(typeof tabId === "string" ? tabId : undefined));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onProjectTreeChanged(cb: () => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("project-tree:changed", () => cb());
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onSessionRecovered(cb: (payload: SessionRecoveryEvent) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("session:recovered", (_e: any, payload?: unknown) => cb((payload ?? {}) as SessionRecoveryEvent));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onSessionRecoveryFailed(cb: (payload: SessionRecoveryFailedEvent) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("session:recovery-failed", (_e: any, payload?: unknown) => cb((payload ?? {}) as SessionRecoveryFailedEvent));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onRemoteStatus(cb: (s: RemoteConnectionStatus) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("remote:status", (_e: any, payload?: unknown) => cb((payload ?? {}) as RemoteConnectionStatus));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onRemoteForwards(cb: (e: RemoteForwardsEvent) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("remote:forwards", (_e: any, payload?: unknown) => cb((payload ?? {}) as RemoteForwardsEvent));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onRemoteServer(cb: (s: RemoteServerView) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("remote:server", (_e: any, payload?: unknown) => cb((payload ?? {}) as RemoteServerView));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onProviderTrust(cb: (prompt: ProviderTrustPrompt) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("remote:provider-trust", (_e: any, payload?: unknown) => cb((payload ?? {}) as ProviderTrustPrompt));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
export function onWorkbenchTarget(cb: (target: WorkbenchActiveTarget) => void): () => void {
  if (typeof window !== "undefined" && window.hoya) {
    return window.hoya.on("remote:workbench-target", (_e: any, payload?: unknown) => cb((payload ?? { kind: "local" }) as WorkbenchActiveTarget));
  }
  if (realApp() && typeof window !== "undefined" && window.runtime) {
...
const mockProviderPresetTemplates: MockProviderPresetTemplate[] = [
  ...
  mockPreset("gmi", "GMI Cloud", "GMI Cloud direct multi-model OpenAI-compatible gateway.", "GMI_API_KEY", mockProviderTemplate({ name: "gmi", kind: "openai", baseUrl: "https://api.gmi-serving.com/v1", models: mockGMIModels, default: "zai-org/GLM-5.2-FP8", apiKeyEnv: "GMI_API_KEY", headers: { "User-Agent": "Hoya Agent" } })),
...
function makeMockApp(): AppBindings {
  ...
  let mockThemePacks: import("./themePack").ThemePackView[] = [
    { id: "graphite", name: "Graphite", author: "Hoya Agent", baseStyle: "graphite", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { id: "aurora", name: "Aurora", author: "Hoya Agent", baseStyle: "aurora", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { id: "slate", name: "Slate", author: "Hoya Agent", baseStyle: "slate", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { id: "carbon", name: "Carbon", author: "Hoya Agent", baseStyle: "carbon", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { id: "nocturne", name: "Nocturne", author: "Hoya Agent", baseStyle: "nocturne", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { id: "amber", name: "Amber", author: "Hoya Agent", baseStyle: "amber", builtin: true, kind: "base", active: false, hasBackground: false, tokens: {}, recipes: { density: "comfortable", corners: "soft" } },
    { ...mockOfficialThemeAssets["official-rose-dawn"], id: "official-rose-dawn", name: "Rose Dawn", author: "Hoya Agent Contributors", license: "MIT", baseStyle: "graphite", builtin: true, kind: "official", active: false, hasBackground: true, nameKey: "settings.themes.official.official-rose-dawn.name", descriptionKey: "settings.themes.official.official-rose-dawn.description", tokens: { light: { bg: "#FFF7F8", fg: "#3A252C", accent: "#B43F65" }, dark: { bg: "#1E1419", fg: "#FFF3F6", accent: "#E26D91" } }, recipes: { density: "comfortable", corners: "round" }, background: { focusX: 0.72, focusY: 0.43, safeArea: "left", homeOpacity: 1, taskOpacity: 0.2, overlayStrength: 0.68, paneOpacity: 0.50 } },
    { ...mockOfficialThemeAssets["official-fortune-forge"], id: "official-fortune-forge", name: "Fortune Forge", author: "Hoya Agent Contributors", license: "MIT", baseStyle: "amber", builtin: true, kind: "official", active: false, hasBackground: true, nameKey: "settings.themes.official.official-fortune-forge.name", descriptionKey: "settings.themes.official.official-fortune-forge.description", tokens: { light: { bg: "#FFF8E8", fg: "#382116", accent: "#A92D22" }, dark: { bg: "#1D140D", fg: "#FFF2D1", accent: "#E8AD38" } }, recipes: { density: "comfortable", corners: "soft" }, background: { focusX: 0.74, focusY: 0.44, safeArea: "left", homeOpacity: 1, taskOpacity: 0.2, overlayStrength: 0.7, paneOpacity: 0.50 } },
  ...
  const settings: SettingsView = {
    ...
    agent: { temperature: 0.2, maxSteps: 0, plannerMaxSteps: 0, maxSubagentDepth: 2, maxSubagentConcurrency: 6, maxParallelWriters: 3, systemPrompt: "You are Hoya Agent, a coding agent.", coldResumePrune: true, reasoningLanguage: "auto" },
    bot: {
      enabled: !freshMock,
      model: "",
  ...
  return {
      ...
      if (trimmedInput === "/nested-preview" || trimmedInput === "nested preview" || trimmedInput === "嵌套预览") {
        ...
        emit({
          ...
          tool: {
            id: parentId,
            name: "explore",
            args: JSON.stringify({ task: "在 Hoya Agent 前端中检查工具调用图标和嵌套调用展示" }),
            readOnly: true,
    ...
    async Capabilities() {
      if (typeof window !== "undefined" && (window as any).hoya?.serverConnection) {
        try {
          const conn = await (window as any).hoya.serverConnection();
          if (conn && conn.url) {
            const res = await fetch(`${conn.url}/api/capabilities`, {
          ...
          console.error("Failed to fetch capabilities from backend", e);
        }
      }
      return {
      ...
      if (typeof window !== "undefined" && (window as any).hoya?.serverConnection) {
        try {
          ...
          if (conn && conn.url) {
            ...
            if (res.ok) {
              const data = await res.json();
              if (data.ok) return data.mcp_servers || [];
            }
          }
        } catch (e) {
          console.error("Failed to fetch MCP servers from backend", e);
        }
      }
        ...
        skills: [
          {
            ...
            description: "Review or update a Hoya Agent GitHub PR, address feedback, verify, and publish safely.",
            scope: "project",
            body: "# Hoya Agent PR Followup\n\nUse this skill for repeated Hoya Agent PR work.\n\n## Workflow\n\n1. Confirm branch and PR state.\n2. Inspect the diff.\n3. Fix actionable feedback.\n4. Verify and update the PR.\n",
