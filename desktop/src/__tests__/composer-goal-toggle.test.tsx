...

{
  ...
  ok(document.querySelector(".invocation-display--message")?.textContent?.includes("Hoya Agent Develop") === true, "history recovery ignores slash-prefixed lines inside the task body");
