...
// Theme confirmations stay inside the Hoya Agent UI instead of opening native
...
ok(gallerySource.includes("useConfirmDialog") && librarySource.includes("useConfirmDialog"), "theme flows share the Hoya Agent confirm dialog");
