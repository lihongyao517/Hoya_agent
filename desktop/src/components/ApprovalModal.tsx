...
const configWriteEnglishSubjectPrefix = "write Hoya Agent config: ";
...
function localizeApprovalReason(tool: string, reason: string | undefined, t: Translator): string {
  ...
  if (tool === "config_write") {
    if (!trimmed || trimmed.includes("Hoya Agent-managed configuration file")) return t("approval.configWriteReason");
    return trimmed;
  }
